...
<div class="menu">' + countries + '</div>');
  ...
  var translate = function (countryElement) {
    ...
    var ad_country = get.gettext("Andorra");
    var ae_country = get.gettext("United Arab Emirates");
    var af_country = get.gettext("Afghanistan");
    var ag_country = get.gettext("Antigua and Barbuda");
    var ai_country = get.gettext("Anguilla");
    var al_country = get.gettext("Albania");
    var am_country = get.gettext("Armenia");
    var ao_country = get.gettext("Angola");
    var aq_country = get.gettext("Antarctica");
    var ar_country = get.gettext("Argentina");
    var as_country = get.gettext("American Samoa");
    var at_country = get.gettext("Austria");
    var au_country = get.gettext("Australia");
    var aw_country = get.gettext("Aruba");
    var ax_country = get.gettext("Aland Islands");
    var az_country = get.gettext("Azerbaijian");
    var ba_country = get.gettext("Bosnia and Herzegovina");
    var bb_country = get.gettext("Barbados");
    var bd_country = get.gettext("Bangladesh");
    var be_country = get.gettext("Belgium");
    var bf_country = get.gettext("Burkina Faso");
    var bg_country = get.gettext("Bulgaria");
    var bh_country = get.gettext("Bahrain");
    var bi_country = get.gettext("Burundi");
    var bj_country = get.gettext("Benin");
    var bl_country = get.gettext("Saint Barthelemy");
    var bm_country = get.gettext("Bermuda");
    var bn_country = get.gettext("Brunei Darussalam");
    var bo_country = get.gettext("Bolivia (Plurinational State of)");
    var bq_country = get.gettext("Bonaire, Sint Eustatius and Saba");
    var br_country = get.gettext("Brazil");
    var bs_country = get.gettext("Bahamas");
    var bt_country = get.gettext("Bhutan");
    var bw_country = get.gettext("Botswana");
    var by_country = get.gettext("Belarus");
    var bz_country = get.gettext("Belize");
    var ca_country = get.gettext("Canada");
    var cc_country = get.gettext("Cocos (Keeling) Islands");
    var cd_country = get.gettext("Congo (Democratic Republic of the)");
    var cf_country = get.gettext("Central African Republic");
    var cg_country = get.gettext("Congo");
    var ch_country = get.gettext("Switzerland");
    var ci_country = get.gettext("Cote D'ivoire");
    var ck_country = get.gettext("Cook Islands");
    var cl_country = get.gettext("Chile");
    var cm_country = get.gettext("Cameroon");
    var cn_country = get.gettext("China");
    var co_country = get.gettext("Colombia");
    var cr_country = get.gettext("Costa Rica");
    var cu_country = get.gettext("Cuba");
    var cv_country = get.gettext("Cabo Verde");
    var cw_country = get.gettext("Curacao");
    var cx_country = get.gettext("Christmas Island");
    var cy_country = get.gettext("Cyprus");
    var cz_country = get.gettext("Czechia");
    var de_country = get.gettext("Germany");
    var dj_country = get.gettext("Djibouti");
    var dk_country = get.gettext("Denmark");
    var dm_country = get.gettext("Dominica");
    var do1_country = get.gettext("Dominican Republic");
    var dz_country = get.gettext("Algeria");
    var ec_country = get.gettext("Ecuador");
    var ee_country = get.gettext("Estonia");
    var eg_country = get.gettext("Egypt");
    var eh_country = get.gettext("Western Sahara");
    var er_country = get.gettext("Eritrea");
    var es_country = get.gettext("Spain");
    var et_country = get.gettext("Ethiopia");
    var fi_country = get.gettext("Finland");
    var fj_country = get.gettext("Fiji");
    var fk_country = get.gettext("Falkland Islands (Malvinas)");
    var fm_country = get.gettext("Micronesia (Federated States of)");
    var fo_country = get.gettext("Faroe Islands");
    var fr_country = get.gettext("France");
    var ga_country = get.gettext("Gabon");
    var gb_country = get.gettext("United Kingdom of Great Britain and Northern Ireland");
    var gd_country = get.gettext("Grenada");
    var ge_country = get.gettext("Georgia");
    var gf_country = get.gettext("French Guiana");
    var gg_country = get.gettext("Guernsey");
    var gh_country = get.gettext("Ghana");
    var gi_country = get.gettext("Gibraltar");
    var gl_country = get.gettext("Greenland");
    var gm_country = get.gettext("Gambia");
    var gn_country = get.gettext("Guinea");
    var gp_country = get.gettext("Guadeloupe");
    var gq_country = get.gettext("Equatorial Guinea");
    var gr_country = get.gettext("Greece");
    var gs_country = get.gettext("South Georgia and The South Sandwich Islands");
    var gt_country = get.gettext("Guatemala");
    var gu_country = get.gettext("Guam");
    var gw_country = get.gettext("Guinea-Bissau");
    var gy_country = get.gettext("Guyana");
    var hk_country = get.gettext("Hong Kong");
    var hn_country = get.gettext("Honduras");
    var hr_country = get.gettext("Croatia");
    var ht_country = get.gettext("Haiti");
    var hu_country = get.gettext("Hungary");
    var id_country = get.gettext("Indonesia");
    var ie_country = get.gettext("Ireland");
    var il_country = get.gettext("Israel");
    var im_country = get.gettext("Isle of Man");
    var in1_country = get.gettext("India");
    var io_country = get.gettext("British Indian Ocean Territory");
    var iq_country = get.gettext("Iraq");
    var ir_country = get.gettext("Iran (Islamic Republic of)");
    var is_country = get.gettext("Iceland");
    var it_country = get.gettext("Italy");
    var je_country = get.gettext("Jersey");
    var jm_country = get.gettext("Jamaica");
    var jo_country = get.gettext("Jordan");
    var jp_country = get.gettext("Japan");
    var ke_country = get.gettext("Kenya");
    var kg_country = get.gettext("Kyrgyzstan");
    var kh_country = get.gettext("Cambodia");
    var ki_country = get.gettext("Kiribati");
    var km_country = get.gettext("Comoros");
    var kn_country = get.gettext("Saint Kitts and Nevis");
    var kp_country = get.gettext("Korea (Democratic People's Republic of)");
    var kr_country = get.gettext("Korea (Republic of)");
    var kw_country = get.gettext("Kuwait");
    var ky_country = get.gettext("Cayman Islands");
    var kz_country = get.gettext("Kazakhstan");
    var la_country = get.gettext("Lao People's Democratic Republic");
    var lb_country = get.gettext("Lebanon");
    var lc_country = get.gettext("Saint Lucia");
    var li_country = get.gettext("Liechtenstein");
    var lk_country = get.gettext("Sri Lanka");
    var lr_country = get.gettext("Liberia");
    var ls_country = get.gettext("Lesotho");
    var lt_country = get.gettext("Lithuania");
    var lu_country = get.gettext("Luxembourg");
    var lv_country = get.gettext("Latvia");
    var ly_country = get.gettext("Libya");
    var ma_country = get.gettext("Morocco");
    var mc_country = get.gettext("Monaco");
    var md_country = get.gettext("Moldova (Republic of)");
    var me_country = get.gettext("Montenegro");
    var mf_country = get.gettext("Saint Martin (French Part)");
    var mg_country = get.gettext("Madagascar");
    var mh_country = get.gettext("Marshall Islands");
    var mk_country = get.gettext("North Macedonia");
    var ml_country = get.gettext("Mali");
    var mm_country = get.gettext("Myanmar");
    var mn_country = get.gettext("Mongolia");
    var mo_country = get.gettext("Macao");
    var mp_country = get.gettext("Northern Mariana Islands");
    var mq_country = get.gettext("Martinique");
    var mr_country = get.gettext("Mauritania");
    var ms_country = get.gettext("Montserrat");
    var mt_country = get.gettext("Malta");
    var mu_country = get.gettext("Mauritius");
    var mv_country = get.gettext("Maldives");
    var mw_country = get.gettext("Malawi");
    var mx_country = get.gettext("Mexico");
    var my_country = get.gettext("Malaysia");
    var mz_country = get.gettext("Mozambique");
    var na_country = get.gettext("Namibia");
    var nc_country = get.gettext("New Caledonia");
    var ne_country = get.gettext("Niger");
    var nf_country = get.gettext("Norfolk Island");
    var ng_country = get.gettext("Nigeria");
    var ni_country = get.gettext("Nicaragua");
    var nl_country = get.gettext("Netherlands");
    var no_country = get.gettext("Norway");
    var np_country = get.gettext("Nepal");
    var nr_country = get.gettext("Nauru");
    var nu_country = get.gettext("Niue");
    var nz_country = get.gettext("New Zealand");
    var om_country = get.gettext("Oman");
    var pa_country = get.gettext("Panama");
    var pe_country = get.gettext("Peru");
    var pf_country = get.gettext("French Polynesia");
    var pg_country = get.gettext("Papua New Guinea");
    var ph_country = get.gettext("Philippines");
    var pk_country = get.gettext("Pakistan");
    var pl_country = get.gettext("Poland");
    var pm_country = get.gettext("Saint Pierre and Miquelon");
    var pn_country = get.gettext("Pitcairn");
    var pr_country = get.gettext("Puerto Rico");
    var ps_country = get.gettext("Palestine, State of");
    var pt_country = get.gettext("Portugal");
    var pw_country = get.gettext("Palau");
    var py_country = get.gettext("Paraguay");
    var qa_country = get.gettext("Qatar");
    var re_country = get.gettext("Reunion_RE");
    var ro_country = get.gettext("Romania_RO");
    var rs_country = get.gettext("Serbia");
    var ru_country = get.gettext("Russian Federation_RU");
    var rw_country = get.gettext("Rwanda");
    var sa_country = get.gettext("Saudi Arabia");
    var sb_country = get.gettext("Solomon Islands");
    var sc_country = get.gettext("Seychelles");
    var sd_country = get.gettext("Sudan");
    var se_country = get.gettext("Sweden_SE");
    var sg_country = get.gettext("Singapore");
    var sh_country = get.gettext("Saint Helena, Ascension and Tristan Da Cunha");
    var si_country = get.gettext("Slovenia_SI");
    var sj_country = get.gettext("Svalbard and Jan Mayen");
    var sk_country = get.gettext("Slovakia");
    var sl_country = get.gettext("Sierra Leone");
    var sm_country = get.gettext("San Marino");
    var sn_country = get.gettext("Senegal");
    var so_country = get.gettext("Somalia_SO");
    var sr_country = get.gettext("Suriname");
    var ss_country = get.gettext("South Sudan");
    var st_country = get.gettext("Sao Tome and Principe");
    var sv_country = get.gettext("El Salvador");
    var sx_country = get.gettext("Sint Maarten (Dutch Part)");
    var sy_country = get.gettext("Syrian Arab Republic");
    var sz_country = get.gettext("Eswatini");
    var tc_country = get.gettext("Turks and Caicos Islands");
    var td_country = get.gettext("Chad");
    var tf_country = get.gettext("French Southern Territories");
    var tg_country = get.gettext("Togo");
    var th_country = get.gettext("Thailand");
    var tj_country = get.gettext("Tajikistan");
    var tk_country = get.gettext("Tokelau");
    var tl_country = get.gettext("Timor-Leste");
    var tm_country = get.gettext("Turkmenistan");
    var tn_country = get.gettext("Tunisia");
    var to_country = get.gettext("Tonga");
    var tr_country = get.gettext("Turkey");
    var tt_country = get.gettext("Trinidad and Tobago");
    var tv_country = get.gettext("Tuvalu");
    var tw_country = get.gettext("Taiwan (Province of China)");
    var tz_country = get.gettext("Tanzania, United Republic of");
    var ua_country = get.gettext("Ukraine");
    var ug_country = get.gettext("Uganda");
    var um_country = get.gettext("United States Minor Outlying Islands");
    var us_country = get.gettext("United States of America");
    var uy_country = get.gettext("Uruguay");
    var uz_country = get.gettext("Uzbekistan");
    var va_country = get.gettext("Holy See");
    var vc_country = get.gettext("Saint Vincent and The Grenadines");
    var ve_country = get.gettext("enezuela (Bolivarian Republic of)");
    var vg_country = get.gettext("Virgin Islands (British)");
    var vi_country = get.gettext("Virgin Islands (U.S.)");
    var vn_country = get.gettext("Viet Nam");
    var vu_country = get.gettext("Vanuatu");
    var wf_country = get.gettext("Wallis and Futuna");
    var ws_country = get.gettext("Samoa");
    var ye_country = get.gettext("Yemen");
    var yt_country = get.gettext("Mayotte");
    var za_country = get.gettext("South Africa");
    var zm_country = get.gettext("Zambia");
    var zw_country = get.gettext("Zimbabwe");
